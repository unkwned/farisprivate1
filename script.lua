...
local L_3_ = loadstring(game:HttpGet("https://raw.githubusercontent.com/unkwned/farispriv/main/source.lua"))()
local L_4_ = L_3_.CreateLib("💀 Faris Private 💀", "BloodTheme")
local L_5_ = L_4_:NewTab("Aimlock")
local L_6_ = L_5_:NewSection("💀 Faris Private 💀")
L_6_:NewButton(
    "Aimlock",
    "Locks on the user",
    function()
...
local L_8_ = L_7_:NewSection("💀 Faris Private 💀")
L_8_:NewButton(
    "Silent Aim",
...
local L_10_ = L_9_:NewSection("💀 Faris Private 💀")
L_10_:NewButton(
    "Silent Aimlock",
    "Key is Q.",
    function()
...
local L_12_ = L_11_:NewSection("💀 Faris Private 💀")
L_12_:NewButton(
    "Anti-Lock",
    "Key is Z.",
    function()
...
local L_14_ = L_13_:NewSection("💀 Faris Private 💀")
L_14_:NewKeybind(
    "Keybind Gui Toggle",
...
local L_16_ = L_15_:NewSection("💀 Faris Private 💀")
L_16_:NewButton(
    "Admin Base",
    "fr",
    function()
...
local L_19_ = L_17_:NewSection("💀 Faris Private 💀")
L_19_:NewToggle(
    "ESP",
    "ESP",
    function(L_201_arg0)
...
L_6_:NewLabel("DONT UNDERESTIMATE FARIS AIM")
local L_20_ = L_4_:NewTab("Animation Changer")
local L_21_ = L_20_:NewSection("💀 Faris Private 💀")
L_21_:NewButton(
